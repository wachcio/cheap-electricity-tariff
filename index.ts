...
console.log(isCheapTariff(new Date(2024, 12, 27, 12, 50), Tariff.Energa_G12W));
console.log(isCheapTariff(new Date(2022, 12, 26, 21, 50), Tariff.PGE_G12W));
console.log(isCheapTariff(new Date(2024, 1, 1, 22, 1), Tariff.Energa_G12W));
